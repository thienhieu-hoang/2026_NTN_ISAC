...
(from version 6) Run this after calculating `A_DU_msequence in `UEReceiver.m`:
...
(version 1 to version 5) Run this after calculating `A_DU_m` in `BERAnalysis.m`:
...
![[Pasted image 20260623160645.png]]